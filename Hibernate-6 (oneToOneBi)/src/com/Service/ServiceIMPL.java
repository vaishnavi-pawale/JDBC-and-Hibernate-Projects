...
//		Homework
	...
	@Override
	public void displayAdharDetailsOnlyUsingAID() {

	}

	@Override
	public void updatePersonDetailsOnlyUsingAID() {
		Scanner sc = new Scanner(System.in);
		Session session = sf.openSession();
		System.out.println("Enter the AdharID :- ");
		Adhar adhar = session.get(Adhar.class, sc.nextInt());
	...
	@Override
	public void updateAdharDetailsOnlyUsingAID() {
		// TODO Auto-generated method stub
	...
	public void deletePersonOnlyUsingAID() {
		...
		if (adhar != null) {
			...
			// adhar ->person(null) , person -> adhar(null)
